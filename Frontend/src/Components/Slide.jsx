...
const slides = [
  {
    ...
    image: "https://res.cloudinary.com/duji9wpsp/image/upload/v1755154836/web_logo_okpvua.png",
    seoTitle: "Website Development | Bimfrox",
    seoDescription: "Custom, scalable, and responsive websites designed to boost your brand online.",
    seoKeywords: "Website Development, Web Design, React Agency, Bimfrox",
  },
  {
    ...
    image: "https://res.cloudinary.com/duji9wpsp/image/upload/v1755154698/app_logo_uoqulq.png",
    seoTitle: "Mobile App Development | Bimfrox",
    seoDescription: "We create high-performance mobile apps that drive engagement and growth.",
    seoKeywords: "Mobile App Development, React Native, iOS Apps, Android Apps",
  },
  {
    ...
    image: "https://res.cloudinary.com/duji9wpsp/image/upload/v1755154833/uiux_logo_pu3d9v.png",
    seoTitle: "UI/UX Design | Bimfrox",
    seoDescription: "Creative and conversion-focused UI/UX designs for seamless user experiences.",
    seoKeywords: "UI Design, UX Design, Wireframes, Prototypes, Bimfrox",
  },
  {
    ...
    image: "https://res.cloudinary.com/duji9wpsp/image/upload/v1755154720/seo_logo_esmzhp.png",
    seoTitle: "Digital Marketing | Bimfrox",
    seoDescription: "Data-driven digital marketing strategies to scale your brand visibility.",
    seoKeywords: "Digital Marketing, Online Ads, Branding, SEO Services",
  },
  {
    ...
    image: "https://res.cloudinary.com/duji9wpsp/image/upload/v1755154630/Digi_logo_zhubyj.png",
    seoTitle: "SEO Optimization | Bimfrox",
    seoDescription: "Boost your visibility and rank higher with advanced SEO strategies.",
    seoKeywords: "SEO Optimization, Google Ranking, Keyword Research, Bimfrox",
  },
];
...
const Slide = () => {
  ...
  const { tagline, description, image, seoTitle, seoDescription, seoKeywords } =
    slides[currentSlide];
