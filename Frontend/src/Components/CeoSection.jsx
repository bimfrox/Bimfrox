...
export default function CeoSection() {
  return (
    <>
      {/* ✅ SEO Meta Tags */}
      <Helmet>
        <title>Meet Our CEO | BIMFROX</title>
        <meta
          name="description"
          content="Meet Rahul Chaursiya, CEO of BIMFROX — empowering Tier 2 & Tier 3 businesses with digital growth solutions."
        />
        <meta
          name="keywords"
          content="BIMFROX CEO, Rahul Chaursiya, Digital Solutions, Startup India, Small Business Growth"
        />
        <meta property="og:title" content="Meet Our CEO | BIMFROX" />
        <meta
          property="og:description"
          content="Rahul Chaursiya, CEO of BIMFROX, is a visionary leader helping local businesses grow digitally."
        />
        <meta property="og:image" content={ceoImg} />
